...
the buffer.Movements in Vim are also callled "nouns",because they refer to chunks of text.
 ...
 - Screen:**H** (highest:top of screen),**M**(middle of screen),**L**(bottom of screen)
...
- **d{motion}** delete {motion}
	...
	beginning of line,**de** is delete to end of word
	- **dd** is delete the current line
- **c{motion}** change {motion}
	- e.g. **cw** is change word
	- like **d{motion} followed by **i**
	- **cc** is delete the current line,and go to insert mode
...
- Lots more to learn:e.g. **~** filps the case of a character
	- **U/u** in visual mode,change character to Uppercase or Lowercase
...
inspiration,for example,your instructors's Vim configs([Anish](https://github.com/anishathalye/dotfiles/blob/master/vimrc),[Jon](https://github.com/jonhoo/configs/blob/master/editor/.config/nvim/init.vim)
(uses [neovim](https://neovim.io/),[Jose](https://github.com/JJGO/dotfiles/blob/master/vim/.vimrc)).There are lots of good blog posts on this topic too.
...
you might find on the internet,you do not need to use a plugin manager for Vim
(since Vim 8.0).Instead,you can use the built-in package management system.
...
- **r** r[character] replace only this character
- **R** switch to replace mode,overwrite the buffers

### Multiple windows
- **:sp** / **:vsp** to split windows
	- **:sp(Ctrl-w s)** is short of **:split** split window horizontally
	- **:vsp(Ctrl-w v)** is short of **:vsplit** split window vertically
	- **:q(Ctrl-w c)** quit/close current window/tab
	- **:qa(Ctrl-w ac)** quit all
- Can have multiple views of the same buffer.

### Multiple tab
- **:tabnew [name]** to new [name] tab
- **gt / gT** to next tab / prior tab
...
- Example:convert xml to json([file]())
	...
	- Vim commands / macros
		...
		- Macro to format a person and go to the next person
			- Go to line with **<person>**
			- **qq@pjq**
		- Execute macro until end of life
			- **999@q**
